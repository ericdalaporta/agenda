...
from agendamentos.views import AgendamentosView, AgendamentoAddView, \
    AgendamentoUpdateView, AgendamentoDeleteView, AgendamentoExibir, AgendamentosGraficoView
